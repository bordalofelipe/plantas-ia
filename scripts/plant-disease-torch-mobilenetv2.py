...
## Setup
dataset_path = '../../new-plant-diseases-dataset/data/'
...
## Model
model = PlantDiseaseModelMobileNetV2(len(full_dataset.classes))
...
torch.save(model, 'plant-disease.pth')

import json
with open('../models/plant-disease-output.json', 'w') as f:
    json.dump(output, f)
